...
func main() {
	...
	flag.StringVar(&renderer, "renderer", "waveform", "renderer: waveform, waveform-long, worldline, worldline-hybrid, worldline-hybrid-cv, or worldline-hybrid-cv-balanced")
